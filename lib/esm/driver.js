...
import { basename, sha } from "mobiletto-orm";
const MEDIA_DRIVERS = {};
...
const parseProfile = (profileRepo, operations, profile, plugin) => __awaiter(void 0, void 0, void 0, function* () {
...
export const destinationPath = (sourceAsset, media, profile, filename) => `${ASSET_PATH_PREFIX}/${basename(sourceAsset)}/${sha(sourceAsset)}/${media}/${profile}/${basename(filename)}`;
