...
export const parseProfile = (mediaProfileRepo, mediaOperationRepo, profile, profileCache) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (profileCache)
        profileCache[profile.name] = parsed;
    return parsed;
});
